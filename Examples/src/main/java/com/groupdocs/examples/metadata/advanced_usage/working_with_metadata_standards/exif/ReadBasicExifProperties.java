 ...
 */
public class ReadBasicExifProperties {
    public static IExif run(Path inputFile) {
        try (Metadata metadata = new Metadata(inputFile.toString())) {
            ...
            if (root.getExifPackage() != null) {
                ...
                System.out.printf("\tImage Width: %s%n", root.getExifPackage().getImageWidth());
                System.out.printf("\tImage Length: %s%n", root.getExifPackage().getImageLength());
