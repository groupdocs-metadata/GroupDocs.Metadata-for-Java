...
class ProjectManagementReadCustomPropertiesTests extends TestsSetUp {


    @Test
    void testRun() {
        ProjectManagementRootPackage result = ProjectManagementReadCustomProperties.run(SampleFiles.INPUT_MPP);
